...
const BlogPost = () => {
  return (
    <div className=" flex flex-col  col-span-2 ">
                {
                  BlogData.map((item)=>(
                    <div className=" flex flex-col  mb-10 gap-y-4 md:gap-y-8">
                <div className=" w-full  object-cover">
                  <img src={item.image}/>
                
                </div>
                <div className=" w-full relative h-auto md:h-52 flex justify-center">
                        <div className=" bg-white w-[95%] flex flex-col gap-y-[6px] md:absolute -top-[75px] px-1 md:px-5 md:py-4 py-2 m-auto">
                  ...
                  <p className=" text-xs md:text-sm leading-5 text-darkText">
                  {item.description}
                  </p>
